...
//Global constants: Prathamesh
int pipeFDS[2];

#include <net_mosq.h>

/* ================= 
*   External API Functions : Prathamesh
*/

int initilaizeMqttLib(int *);


/* ============================================================
 * Main functions
 * ============================================================ */
int mosquitto_main_loop(struct mosquitto_db *db, mosq_sock_t *listensock, int listensock_count, int listener_max,int *);
 ...
 * Network functions
 * ============================================================ */
int mqtt3_socket_accept(struct mosquitto_db *db, mosq_sock_t listensock,int *);
