...
int initilaizeMqttLib(int *pipefds)
{
...
//	}
    ...
    rc = mqtt3_config_parse_args(&config, NULL, NULL);
	...
	run = 1;
	rc = mosquitto_main_loop(&int_db, listensock, listensock_count, listener_max,pipefds);
